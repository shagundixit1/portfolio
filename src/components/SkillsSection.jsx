...
const skills = [
 ...
 // DevOps (skills only)
  ...
  { name: "Monitoring & Logging", level: 70, category: "devops" },


  // Tools (including DevOps tools)
  { name: "Git/GitHub", level: 90, category: "tools" },
  { name: "Figma", level: 85, category: "tools" },
  { name: "VS Code", level: 95, category: "tools" },
  { name: "Docker", level: 80, category: "tools" },
  { name: "New Relic", level: 60, category: "tools" },
  { name: "Prometheus", level: 60, category: "tools" },
  { name: "Grafana", level: 60, category: "tools" },
  { name: "Apache Kafka", level: 55, category: "tools" },
];
